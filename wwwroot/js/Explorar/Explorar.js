document.addEventListener('DOMContentLoaded', () => {
    let Tendencia;
    let ContenedorTendencias = document.getElementById('ContenedorTendencias');
    ...
    function ActualizarTendencias() {
        ...
        try {
            TendenciasActuales.forEach((tendencia) => {
                Tendencia += `
            <div class="TendenciaCreada">
                <div class="row">
                    <div class="col-11"><p id="pEncabezadoTendencia">${tendencia.tipo}</p></div>
                    <div class="col-1"><p class="p3puntos">...</p></div>
                </div>
                <p id="PTendencia">${tendencia.nombre}</p>
                <p id="pcantidadDePosts">${tendencia.posts} posts posts</p>
            </div>
            `;
            });
        } catch (error) {
        ...
        ContenedorTendencias.innerHTML += Tendencia;
    }
